...
import static com.rockchip.gpadc.demo.rga.HALDefine.INPUT_CHANNEL;
...
public class CameraPreviewActivity extends Activity implements Camera.PreviewCallback {
    ...
    // for inference
    private String mModelName = "retinaface.rknn";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (platform.equals("rk3588")) {
            createFile(mModelName, R.raw.retinaface);
        } else {
...
//        mSurfaceView.setZOrderMediaOverlay(true);
    ...
    private void showTrackSelectResults() {
        ...
        for (int i = 0; i < recognitions.size(); ++i) {
            ...
            mTrackResultCanvas.drawCircle(rego.getPoints()[0], rego.getPoints()[1], 3, paint);
            mTrackResultCanvas.drawCircle(rego.getPoints()[2], rego.getPoints()[3], 3, paint);
            paint.setColor(Color.GREEN);
            mTrackResultCanvas.drawCircle(rego.getPoints()[4], rego.getPoints()[5], 3, paint);
            paint.setColor(Color.BLUE);
            mTrackResultCanvas.drawCircle(rego.getPoints()[6], rego.getPoints()[7], 3, paint);
            mTrackResultCanvas.drawCircle(rego.getPoints()[8], rego.getPoints()[9], 3, paint);

            mTrackResultCanvas.drawRect(detection, mTrackResultPaint);
            mTrackResultCanvas.drawText(((int) (rego.getScore() * 100)) + "%",
